...
### Regression study
```{r}
mod <- lm(Mental_Health ~ Income_Inequality + Wages + Unemployment + Working_Age + Work_Time + tab$GDP + TIME, data = tab)
