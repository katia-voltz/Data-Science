...
Concerning the average wage, we see that the results are rather spread out while having a distribution that follows the geomsooth and a positive linear slope. 
...
Again here the results are concentrated and have a distribution according to the geomsmooth. The linear slope is positive on average. We can see that it is not the countries with the highest unemployment rate that have the most serious prevalence of Mental Health. We can also notice that some countries like Poland, Portugal, Spain and Greece have an unemployment rate that is increasing a lot in the last years.
