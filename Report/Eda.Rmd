...
```{r, warning=FALSE}
P2 <- ggplot(data = tab, mapping = aes(x = tab$Wages, y = tab$Mental_Health)) +
  geom_point(mapping = aes(color = LOCATION)) +
  geom_smooth()+
  xlim(0,70000) + 
  ylim(0,20)+
...
```{r, warning=FALSE}
P3 <- ggplot(data = tab, mapping = aes(x = tab$Unemployment, y = tab$Mental_Health)) +
  geom_point(mapping = aes(color = LOCATION)) +
  geom_smooth() +
  xlim(0,28.0) + 
  ylim(0,20)+
...
```{r, warning=FALSE}
P4 <- ggplot(data = tab, mapping = aes(x = tab$Working_Age, y = tab$Mental_Health)) +
  geom_point(mapping = aes(color = LOCATION)) +
  geom_smooth() +
  ylim(0,20)+
...
##### GDP Analysis
```{r, warning=FALSE}
P5 <- ggplot(data = tab, mapping = aes(x = tab$GDP, y = tab$Mental_Health)) +
  geom_point(mapping = aes(color = LOCATION)) +
  geom_smooth() +
  xlim(0,84057) + 
  ylim(0,20)+
