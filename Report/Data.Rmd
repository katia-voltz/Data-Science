...
```
```{r, echo = FALSE, message = FALSE}
kbl(Antidepressant_consumption2[1:15,],caption = "**Table of antidepressant consumption**: `Antidepressant_consumption2`, ...") %>%
  kable_classic(full_width = T, html_font = "Cambria") %>%
  kable_styling(bootstrap_options = c('striped', 'hover', 'condensed'))
rm(v)
```
...
```{r, echo = FALSE, message = FALSE}
kbl(tab_R2.1[1:10,],caption = "**Table of antidepressant consumption and covid-19 cases**: `tab_R2.1`, ...") %>%
  kable_classic(full_width = T, html_font = "Cambria") %>%
  kable_styling(bootstrap_options = c('striped', 'hover', 'condensed'))
rm(v)
```
...
```{r, echo = FALSE, message = FALSE}
kbl(Depression_Rate2000_2021[1:10,],caption = "**Depression Rate from 2000 to 2021**: `Depression_Rate2000_2021`, ...") %>%
  kable_classic(full_width = T, html_font = "Cambria") %>%
  kable_styling(bootstrap_options = c('striped', 'hover', 'condensed'))
rm(v)
```
...
```
```{r, echo = FALSE, message = FALSE}
kbl(Teleworking[1:10,],caption = "**Teleworking**: `Teleworking`, ...") %>%
  kable_classic(full_width = T, html_font = "Cambria") %>%
  kable_styling(bootstrap_options = c('striped', 'hover', 'condensed'))
rm(v)
```
...
```
```{r, echo = FALSE, message = FALSE}
kbl(UnemploymentCovid[1:10,],caption = "*UnemploymentCovid**: `UnemploymentCovid`, ...") %>%
  kable_classic(full_width = T, html_font = "Cambria") %>%
  kable_styling(bootstrap_options = c('striped', 'hover', 'condensed'))
rm(v)
```
...
```{r, echo = FALSE, message = FALSE}
kbl(tab_R2.2[1:20,],caption = "*tab_R2.2**: `tab_R2.2`, ...") %>%
  kable_classic(full_width = T, html_font = "Cambria") %>%
  kable_styling(bootstrap_options = c('striped', 'hover', 'condensed'))
rm(v)
```
