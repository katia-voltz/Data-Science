...
```{r}
kbl(tab_1[1:20,],caption = "**Table 3**^a^: Table of Public spending on health and mental health: `tab_1`") %>%
  kable_classic(full_width = T, html_font = "Cambria") %>%
  kable_styling(bootstrap_options = c('striped', 'hover', 'condensed')) %>%
  add_footnote(
      paste(
...
```{r}
kbl(tab_2[1:20,],caption = "**Table 3**^b^Table aggregated of Public spending on health and mental health: `tab_2`") %>%
  kable_classic(full_width = T, html_font = "Cambria") %>%
  kable_styling(bootstrap_options = c('striped', 'hover', 'condensed')) %>%
  add_footnote(
      paste(
