...
````{r}
Anxiety <- read.csv(here::here("Data/Régression 1/share-with-anxiety-disorders.csv"))
attach(Anxiety)
Anxiety <- Anxiety[,-1]
...
Depression <- read.csv(here::here("Data/Régression 1/dalys-depression-age-std-rate.csv"))
attach(Depression)
...
In this thrid analysis of datasets,  we are going to compare the prevalence of mental health disorder (in % of the population (age-standardaized)) in a population of a country and the current health expenditure (% of GDP). Particularly focus on the countries of the OCDE that is The Organisation for Economic Co-operation and Development.
