...
```{r}
Mental_Health <- read.csv(here::here("Data/Régression 1/Mental Health.csv"))
...
Income_Inequality <- read.csv2(here::here("Data/Régression 1/Income inequality-1.csv"))
...
wages <- read.csv(here::here("Data/Régression 1/Average wages.csv"))
attach(wages)
wages <- wages[,-c(2:5,8)]
...
Unemployment <- read.csv(here::here("Data/Régression 1/Unemployement Rate.csv"))
attach(Unemployment)
...
Working_Age <- read.csv(here::here("Data/Régression 1/Working age population.csv"))
attach(Working_Age)
...
Work_Time <- read.csv(here::here("Data/Régression 1/Avg Work Time.csv"))
attach(Work_Time)
...
GDP <- read.csv(here::here("Data/Régression 1/gdp-per-capita.csv"))
attach(GDP)
GDP <- GDP[,-c(1,5)]
...
```{r, echo = FALSE, message = FALSE}
Antidepressant_consumption <- read.csv(here::here("Data/Régression 2/Conso Antidepressant.csv"))
...
```{r, echo = FALSE, message = FALSE}
Number_Covid19_cases_deaths <- read.csv2(here::here("Data/Régression 2/Cases + Deaths Covid.csv"))
...
```{r, echo = FALSE, message = FALSE}
Depression_Rate2000_2017 <- read.csv(here::here("Data/Régression 2/Depression Rate 2000:2017.csv"))
...
```{r, echo = FALSE, message = FALSE}
Depression_Rate2021 <- read.csv2(here::here("Data/Régression 2/Depression Rate 2021.csv"))
...
```{r, echo = FALSE, message = FALSE}
Teleworking <- read.csv2(here::here("Data/Régression 2/Teleworking.csv"))
attach(Teleworking)
...
```{r, echo = FALSE, message = FALSE}
UnemploymentCovid <- read.csv(here::here("Data/Régression 2/Unemployement Rate.csv"))
...
```{r}
Public.spending.on.health_New <- read.csv2(here::here('Data/Régression 3/Public.spending.on.health.csv'))
```
