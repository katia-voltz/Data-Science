...
We remove the 3 first rows and we rename the different variables in the columns to get the same structure as previusly.
...
Also, the **Indicator Name**, **Indicator Code** are unrelevant data.
...
```
 ...
 Our initial dataframe as for variables names [(X.n),(X.n+1)...(X.m)], we need to transform them as Years. 
