...
First, here is the list of the selected countries. In continuation of our analysis, we keep the OECD countries to answer our research questions.

```{r}
tab.of.countries <- read.csv2(here::here('Data/Entities_LOCATION_Region.csv')
kable(tab.of.countries)
```
