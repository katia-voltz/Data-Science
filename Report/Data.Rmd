...
```{r, echo = FALSE, message = FALSE}
tab_countries <- read.csv2('Data/Entities_LOCATION_Region.csv')
```
...
Income_Inequality <- read.csv2("Data/Income_inequality-1.csv")
...
wages <- read.csv("Data/Average_wages.csv")
attach(wages)
wages <- wages[,-c(2:5,8)]
List.of.Countries = c('AUT','BEL','HRV', 'CZE', 'DNK', 'ENG', 'FIN', 'FRA', 'DEU', 'GRC', 'HUN', 'ISL', 'ITA', 'ROU', 'PRT', 'POL', 'NOR', 'NLD', 'CHE', 'SWE', 'ESP', 'AUS', 'BRA', 'CAN', 'JPN', 'NZL', 'USA')
...
Unemployment <- read.csv("Data/Unemployement_Rate1.csv")
attach(Unemployment)
...
Working_Age <- read.csv("Data/Working_age_population.csv")
attach(Working_Age)
...
Work_Time <- read.csv("Data/Avg_Work_Time.csv")
attach(Work_Time)
