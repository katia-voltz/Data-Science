...
Unemployment <- read.csv(here::here("Data/Regression1/Unemployement_Rate1.csv"))
attach(Unemployment)
...
```{r, echo = FALSE, message = FALSE}
UnemploymentCovid <- read.csv(here::here("Data/Regression2/Unemployement_Rate2.csv"))
...
```{r,echo = FALSE, message = FALSE}
share.with.mental.and.substance.disorders <- read.csv2(here::here('Data/Regression3/share-with-mental-and-substance-disorders_copie.csv'))
```
