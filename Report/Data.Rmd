...
List.of.Countries = c('AUT','BEL','HRV', 'CZE', 'DNK', 'ENG', 'FIN', 'FRA', 'DEU', 'GRC', 'HUN','ISL',
                      ...
                      'CAN', 'CHN', 'JPN', 'NZL', 'USA')
```
Another list of countries has been made, to select countries to select the countries where we had data available on antidepressant consumption. 
...
````
We can now form a table with the data. 
```{r}
