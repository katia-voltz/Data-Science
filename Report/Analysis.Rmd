...
```
For each of the explanatory variables, the clusters are more or less identical and, these are countries that border or are close to each other.
...
```
As a reminder, antidepressant consumption is defined daily dosage per 1 000 inhabitants per day. 
In the 2 following bar plots, the unit 'u' represents this unit of measure.
