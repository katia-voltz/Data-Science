...
## 1/ Mental health through the work environment
...
## 3/ How public spending on health impacts mental health in OECD countries
...
```
Here is the distrubution of the each country according to spending on health values and mental health disorder prevalence.
...
In these regions, it is more difficult to conclude about the impact of ‘mental health disorder prevalence’ on the ‘value spending on health’. In addition, we must remain vigilant about a potential simultaneity bias. 
