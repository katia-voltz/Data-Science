...
- Data quantification and precision(ex: China with numbers of cases and deaths that seem to be underestimated).
- Large population sample on 'Mental Health' (ex: Children included).
- Lack of data over the years and especially for the covid part.
- Limitation of the OECD countries, this is not representative of the all world.
- Focalisation on 'Mental Health' in the work environment but this is a variable very complex that take into account a lot of other aspects.
